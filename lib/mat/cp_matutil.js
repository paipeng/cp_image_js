...
CpMatUtil.prototype.writeJpeg = function (file_name, mat) {
    //console.log(typeof WechatMiniprogram);
    if ((typeof wx) == 'undefined') {
        //jpeg.encode.writer(file_name, mat);
    }
}
...
CpMatUtil.prototype.createMat = function (width, height, channel) {
    var data = new Uint8Array(width * height * channel).fill(255);
    return {
        data: data,
        width: width,
        height: height,
