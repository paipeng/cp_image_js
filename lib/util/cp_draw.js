...
class CPDraw {
    ...
    /**
     * draw polygon for given point vector
     * @param {CPMat} mat image matrix
     * @param {Array.<CPPoint>} points connected points
     * @param {*} color draw in given color 0xFFFFFF  BGR
     */
